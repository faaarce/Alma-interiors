    ...
    >
      ...
      >
        <div className="flex justify-between items-center">
          ...
          >
            <div
              className="w-10 h-10 rounded-full overflow-hidden transition-transform duration-500 hover:rotate-[360deg]"
          ...
          >
            <a
              ...
              className="hdr-cta group relative inline-flex items-center gap-2 overflow-hidden rounded-full bg-gradient-to-r from-[#D4AF37] to-[#C5A572] px-6 py-2.5 text-sm font-medium text-white shadow-lg transition-all duration-300 hover:scale-105 hover:from-[#C5A572] hover:to-[#D4AF37]"
            >
              <svg
